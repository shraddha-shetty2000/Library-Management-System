...
.h:hover
{
	...
	width:300px;
	height: 50px;
	background-color:#2e964ce6;
}
</style>
</head>
<body>
	<!--__________________________________sidenav_______________________________________-->
...
function closeNav() {
  ...
  document.getElementById("main").style.marginLeft= "0";
	...
	<!--________________________________request book_____________________________________-->
	<div class="srch">
		<form class="navbar-form" method="post" name="form1">
			
				<input class="form-control" type="text" name="BId" placeholder="Enter Book ID" required="">
				<button style="background-color: #2e964ce6;" type="submit" name="submit1" class="btn btn-default">Request
				</button>
		</form>
	</div>	
	<h2>List Of Books</h2>
