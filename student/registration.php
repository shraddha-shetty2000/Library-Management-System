	...
	<section>
        	...
        	<div class="box2">
        	  ...
        	  Library Management System</h1>
        		...
        		<form name="Registration" action="" method="post">
        			...
        			<input class="form-control" type="text" name="usn" placeholder="USN" required=""><br>
	    ...
	    <?php
	      ...
	      if ($count==0) 	
	      	...
	      	{
	      		mysqli_query($db,"INSERT INTO `student` VALUES('$_POST[firstname]','$_POST[lastname]','$_POST[username]'
	      		,'$_POST[password]','$_POST[usn]','$_POST[email]','$_POST[contact]','profile.png');");
	    ?>
